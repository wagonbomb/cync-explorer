#!/usr/bin/env python3
"""
Linux BLE Direct - Connect directly by MAC, no scan phase
Uses BlueZ's cached device info from bluetoothctl
"""
...
async def main():
    print("=" * 60)
    print("LINUX BLE DIRECT - NO SCAN")
    print("=" * 60)
    print(f"Target: {TARGET_MAC}")
    print()
    print("NOTE: Run 'bluetoothctl scan on' in another terminal first!")
    print()

    print("Connecting directly by MAC...")
    try:
