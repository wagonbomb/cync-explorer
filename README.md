...
python ble_scanner.py 34134346ca85
```

### 2. GATT Explorer (`gatt_explorer.py`)

Connects to a Cync light and enumerates all its GATT services and characteristics.

```bash
python gatt_explorer.py 34134346ca85
```
...
### 3. Light Controller (`cync_controller.py`)

Interactive tool to test control commands on the light.

```bash
python cync_controller.py 34134346ca85
```
